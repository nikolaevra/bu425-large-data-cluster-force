...
# Start working here - filter out any rows where target variable is N/A and run a linear model (lm function, I think) to see if there is any connection between target variable and any of the other rows
